...
def build_dataset(args, rank=0, is_test=False):
    ...
    train_env = dataset_class(
        feat_db, train_instr_data, args.connectivity_dir, mp_prob=args.train_mp_prob,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, val_instr_data, args.connectivity_dir, mp_prob=-1.0, batch_size=args.batch_size, 
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
        ...
        val_env_mp = dataset_class(
            feat_db, val_instr_data_mp, args.connectivity_dir, mp_prob=2.0, batch_size=args.batch_size, 
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
            sel_data_idxs=None if args.world_size < 2 else (rank, args.world_size), name=split+"_mp", args=args
        )
