...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='r2r', choices=['r2r', 'r4r', 'cvdn', 'utsd'])
    ...
    parser.add_argument("--train_mp_prob", default=-1.0, type=float, help='prob of training with MP')
    parser.add_argument('--full_obj', action='store_true', default=False)
...
def postprocess_args(args):
    ...
    args.anno_dir = os.path.join(ROOTDIR, 'UTSD', 'annotations', 'image_ndh')
