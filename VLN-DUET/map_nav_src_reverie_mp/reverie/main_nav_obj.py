...
def build_dataset(args, rank=0):
    ...
    if args.aug_only:
        ...
        train_env = dataset_class(
            feat_db, obj_db, train_instr_data, args.connectivity_dir, obj2vps, mp_prob=args.train_mp_prob,
            batch_size=args.batch_size, max_objects=args.max_objects,
    ...
    for split in val_env_names:
        ...
        val_env = dataset_class(
            feat_db, obj_db, val_instr_data, args.connectivity_dir, obj2vps, mp_prob=-1.0,
        ...
        val_env_mp = dataset_class(
            feat_db, obj_db, val_instr_data_mp, args.connectivity_dir, obj2vps, mp_prob=2.0,
            batch_size=args.batch_size, 
            angle_feat_size=args.angle_feat_size, seed=args.seed+rank,
