...
def process_features(proc_id, out_queue, scanvp_list, args):
    ...
    model, preprocess, device = build_feature_extractor(args.model_name, args.checkpoint_file)

    for scan_id, viewpoint_id in scanvp_list:
        images = []
        for ix in range(VIEWPOINT_SIZE):
            image_path = f"/mnt/data/haodong/envedit/views_img/{scan_id}/{viewpoint_id}/{ix}.jpg"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_file', default="./pth_clip_vit_b32_views.hdf5")
