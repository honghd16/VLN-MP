    ...
    def forward(self, mode, txt_ids=None, txt_masks=None, txt_embeds=None, 
        ...
        if mode == 'language':
            if land_embeds is not None:
                land_embeds = self.drop_env(land_embeds)
            encoded_sentence = self.vln_bert(mode, 
                                            txt_ids=txt_ids, txt_masks=txt_masks,
                                            land_embeds=land_embeds, land_masks=land_masks, land_pos=land_pos)
