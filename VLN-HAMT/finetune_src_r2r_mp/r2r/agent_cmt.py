...
class Seq2SeqCMTAgent(BaseAgent):
    ...
    def _prompt_variable(self, obs):
        ...
        if max_lm_len == 0:
            ...
            with h5py.File("../../VLN-DUET/datasets/R2R/features/gelr2r_obj_features.hdf5", 'r') as f:
        ...
        return seq_tensor, mask, target_fts, target_span, seq_lengths
    ...
    def rollout(self, train_ml=None, train_rl=True, reset=True):
        ...
        # Language input
        txt_ids, txt_masks, target_fts, target_span, txt_lens = self._prompt_variable(obs)
