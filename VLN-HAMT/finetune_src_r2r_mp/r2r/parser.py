...
def parse_args():
    ...
    parser.add_argument('--train_mp_prob', type=float, default=-1.0)
    parser.add_argument('--train_mp_type', type=str, default='random')
    parser.add_argument('--pano_lm', action='store_true', default=False)
