...
class VLNBertCMT(nn.Module):
    ...
    def forward(self, mode, txt_ids=None, txt_masks=None, txt_embeds=None, target_fts=None, target_span=None,
        ...
        if mode == 'language':
            encoded_sentence = self.vln_bert(mode, txt_ids=txt_ids, txt_masks=txt_masks, target_fts=target_fts, target_span=target_span)
